...
// const myJSON = '{"Women":[{"Id":"100","category": "sweetShirt","size": ["s","m","l","xl"],"color":"blue","price":"255"}],{"Id":"101","category":"jeans","size": ["s","m","l","xl"],"color":"blue","price":"255"}],'
// '"Men":[{"Id": "200","category":"shirt&blouse","size": ["s","m","l","xl"],"color":"blue","price":"255"},{"Id": "201","category": "jeans","size":["s","m","l","xl"],"color":"blue","price":"255"}],'
// '"Kids":[{  "Id": "300", "category": "shirt&blouse", "size": ["s","m","l","xl"],"color":"blue","price":"255"},{"Id": "301","category": "jeans","size": ["s","m","l","xl"],"color":"blue", "price":"255"}]';
// const myObj = JSON.parse(myJSON);
// console.log(myObj["Women"][0]);


// men category list is 
// KNITWEAR -- SHIRT&BLOUSE --SWEATSHIRTS&HOODIES --JEANS --TROUSERS --TUNICS -- 6category
var men =
[
...
{Id: "344",category:"UNDERWEAR",size:["s","m","l","xl"],color:"blue",price:"255"},
 ...
 var womanCollection = document.getElementsByClassName("woman-col-links");
var menCollection = document.getElementsByClassName("man-col-links");
var kidCollection = document.getElementsByClassName("kid-col-links")
 for(i = 0;i<womanCollection.length;i++)
 {
    womanCollection[i].addEventListener("click" , function(event){
    // console.log(event.target.innerText);
        setSessionLinkDirector("woman" , event)
    });
 }
 
 for(i = 0;i<menCollection.length;i++)
 {
    menCollection[i].addEventListener("click" , function(event){
    // console.log(event.target.innerText);
        setSessionLinkDirector("man" , event)
    });
 }
 for(i = 0;i<kidCollection.length;i++)
 {
    kidCollection[i].addEventListener("click" , function(event){
    // console.log(event.target.innerText);
        setSessionLinkDirector("kid" , event)
    });
 }
 
 function setSessionLinkDirector(collectionName , event)
 {
